...
import pytest
from debate_sdk.shared.contracts import FinalJudgmentSchema, ChildToParentMessage, ArgumentPayload, JudgmentJustification
...
def test_judge_handles_budget_exception(mock_config):
    ...
    with patch("google.generativeai.GenerativeModel"):
        ...
        with patch.object(judge, "handle_message", side_effect=BudgetExceededException("Out of money")):
            with patch.object(judge, "terminate_children") as mock_halt:
                with patch.object(judge, "evaluate_debate") as mock_eval:
                    ...
                    assert any(j["point"] == "RESOURCE_TRUNCATION" for j in final_judgment["justification"])
